...
<body>
    ...
    <div class="container">
        <div class="navbar">
            ...
            <h1>Materiales Guzman | Eliminar usuario</h1>
        </div>
        <!--TODO EL CONTENIDO SE DEBE DE PONER DENTRO DE LA CLASS MAIN, YA QUE ES LA QUE HACE QUE SE ADAPTE AL MOVIMIENTO DE LA BARRA-->
        <div class="main"> 
            <h2 style="text-align:center;font-size:40px">Selecciona el usuario que quieres eliminar:</h2>
            <p style="text-align:center; padding-top:30px;"><img src="Usuarios_Eliminar.png" width=1080 height=300></p>
        </div>
