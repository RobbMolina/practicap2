...
<body>
    ...
    <div class="container">
        ...
        <div class="main">  
        <h2 style="text-align:center;font-size:40px">Selecciona el usuario que quieres modificar:</h2>
            <p style="text-align:center; padding-top:30px;"><a href="modificar_usuario2.php"><img src="Usuarios_Eliminar.png" width=1080 height=300></a></p>
